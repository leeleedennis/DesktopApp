...
namespace DesktopApp {
    ...
    public partial class InventoryDataSet5 : global::System.Data.DataSet {
        ...
        public partial class UsersDataTable : global::System.Data.TypedTableBase<UsersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
            public UsersRow AddUsersRow(string F_Name, string L_Name, string Username, string Password, string Type, System.DateTime Date_Created, string Created_By) {
...
namespace DesktopApp.InventoryDataSet5TableAdapters {
    ...
    public partial class UsersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Users] WHERE (([user_id] = @Original_user_id) AND ([F_Name] = @Original_F_Name) AND ([L_Name] = @Original_L_Name) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)) AND ([Date_Created] = @Original_Date_Created) AND ([Created_By] = @Original_Created_By))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Users] ([F_Name], [L_Name], [Username], [Password], [Type], [Date_Created], [Created_By]) VALUES (@F_Name, @L_Name, @Username, @Password, @Type, @Date_Created, @Created_By);
SELECT user_id, F_Name, L_Name, Username, Password, Type, Date_Created, Created_By FROM Users WHERE (user_id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Users] SET [F_Name] = @F_Name, [L_Name] = @L_Name, [Username] = @Username, [Password] = @Password, [Type] = @Type, [Date_Created] = @Date_Created, [Created_By] = @Created_By WHERE (([user_id] = @Original_user_id) AND ([F_Name] = @Original_F_Name) AND ([L_Name] = @Original_L_Name) AND ([Username] = @Original_Username) AND ([Password] = @Original_Password) AND ((@IsNull_Type = 1 AND [Type] IS NULL) OR ([Type] = @Original_Type)) AND ([Date_Created] = @Original_Date_Created) AND ([Created_By] = @Original_Created_By));
SELECT user_id, F_Name, L_Name, Username, Password, Type, Date_Created, Created_By FROM Users WHERE (user_id = @user_id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT user_id, F_Name, L_Name, Username, Password, Type, Date_Created, Created_B" +
                "y FROM dbo.Users";
        ...
        public virtual int Fill(InventoryDataSet5.UsersDataTable dataTable) {
        ...
        public virtual InventoryDataSet5.UsersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            InventoryDataSet5.UsersDataTable dataTable = new InventoryDataSet5.UsersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "15.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(InventoryDataSet5.UsersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_user_id, string Original_F_Name, string Original_L_Name, string Original_Username, string Original_Password, string Original_Type, System.DateTime Original_Date_Created, string Original_Created_By) {
            ...
            this.Adapter.DeleteCommand.Parameters[7].Value = ((System.DateTime)(Original_Date_Created));
        ...
        public virtual int Insert(string F_Name, string L_Name, string Username, string Password, string Type, System.DateTime Date_Created, string Created_By) {
            if ((F_Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string F_Name, string L_Name, string Username, string Password, string Type, System.DateTime Date_Created, string Created_By, int Original_user_id, string Original_F_Name, string Original_L_Name, string Original_Username, string Original_Password, string Original_Type, System.DateTime Original_Date_Created, string Original_Created_By) {
            return this.Update(F_Name, L_Name, Username, Password, Type, Date_Created, Created_By, Original_user_id, Original_F_Name, Original_L_Name, Original_Username, Original_Password, Original_Type, Original_Date_Created, Original_Created_By, Original_user_id);
        }
    }
