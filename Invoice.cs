...
/*
        ...
        {
            double d1, e1, l;
            double.TryParse(comboBox4.Text, out d1);
            double.TryParse(zeroltextBox3.Text, out e1);
            l = d1 * e1;
        ...
        private void printDocument1_PrintPage(object sender, System.Drawing.Printing.PrintPageEventArgs e)
        {
            ...
            e.Graphics.DrawString("Date: " + DateTime.Now, new System.Drawing.Font("Arial", 12), Brushes.Black, new Point(25, 230));
            e.Graphics.DrawString("Customer: " + InvoiceGridView.Rows[i].Cells[5].FormattedValue.ToString(), InvoiceGridView.Font, Brushes.Black, new System.Drawing.Rectangle(25, 210, InvoiceGridView.Columns[1].Width, InvoiceGridView.Rows[0].Height));
